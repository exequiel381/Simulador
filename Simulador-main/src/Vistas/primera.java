...
public class primera extends javax.swing.JFrame {
    ...
    public static final String INICIAR = "INICAR";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SIMULADOR DEL PROCESO DEL DULCE DE LECHE");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 90, 630, 60));
        ...
        btnIniciar.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 3, true));
        ...
        getContentPane().add(btnIniciar, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 200, 220, 70));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/ddlFondo.jpg"))); // NOI18N
    ...
    private void btnIniciarMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnIniciarMouseMoved
        btnIniciar.setBorder(javax.swing.BorderFactory.createLineBorder(Color.white,3));          // TODO add your handling code here:
    ...
    private void btnIniciarMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnIniciarMouseExited
        btnIniciar.setBorder(javax.swing.BorderFactory.createLineBorder(Color.black,3));        // TODO add your handling code here:
